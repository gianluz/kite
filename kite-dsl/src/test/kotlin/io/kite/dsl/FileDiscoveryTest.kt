...
class FileDiscoveryTest {
    ...
    @Test
    fun `loadSegments returns empty when no files`() =
        runTest {
            val discovery = FileDiscovery(workspaceRoot = tempDir)
    ...
    @Test
    fun `loadRides returns empty when no files`() =
        runTest {
            val discovery = FileDiscovery(workspaceRoot = tempDir)
    ...
    @Test
    fun `loadSegments loads valid segment files`() =
        runTest {
            // Create directory structure
            val segmentsDir = File(tempDir, ".kite/segments").apply { mkdirs() }
    ...
    @Test
    fun `loadRides loads valid ride files`() =
        runTest {
            // Create directory structure
            val ridesDir = File(tempDir, ".kite/rides").apply { mkdirs() }
    ...
    @Test
    fun `loadSegments handles compilation errors`() =
        runTest {
            // Create directory structure
            val segmentsDir = File(tempDir, ".kite/segments").apply { mkdirs() }
    ...
    @Test
    fun `loadAll loads both segments and rides`() =
        runTest {
            // Create directory structure
            val segmentsDir = File(tempDir, ".kite/segments").apply { mkdirs() }
            val ridesDir = File(tempDir, ".kite/rides").apply { mkdirs() }
    ...
    @Test
    fun `KiteLoadResult provides segment map`() =
        runTest {
            val segmentsDir = File(tempDir, ".kite/segments").apply { mkdirs() }
    ...
    @Test
    fun `KiteLoadResult provides ride map`() =
        runTest {
            val ridesDir = File(tempDir, ".kite/rides").apply { mkdirs() }
