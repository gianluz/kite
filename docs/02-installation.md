...
3. **Check Dependencies**:
   ...
   Should show:
   ```
   +--- com.gianluz.kite:kite-core:0.1.0-alpha5
   +--- com.gianluz.kite:kite-dsl:0.1.0-alpha5
   +--- com.gianluz.kite:kite-runtime:0.1.0-alpha5
   ```
...
2. **Check Version**:
   Ensure you're using a published version (e.g., `0.1.0-alpha5`, not `0.1.0-SNAPSHOT`)
