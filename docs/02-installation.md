...
curl -sSL https://github.com/gianluz/kite/releases/latest/download/install.sh \
  | KITE_VERSION=v0.1.0-alpha10 bash
```
...
curl -LO https://github.com/gianluz/kite/releases/latest/download/kite-cli-0.1.0-alpha10.tar
tar -xf kite-cli-0.1.0-alpha10.tar

# Add to PATH
export PATH="$PWD/kite-cli-0.1.0-alpha10/bin:$PATH"
kite-cli --version
```
...
// build.gradle.kts
dependencies {
    implementation("com.gianluz.kite:kite-core:0.1.0-alpha10") // ← Update version
    implementation("com.gianluz.kite:kite-dsl:0.1.0-alpha10")
    implementation("com.gianluz.kite:kite-runtime:0.1.0-alpha10")
}
```
...
3. **Check Dependencies**:
   ...
   Should show:
   ```
   +--- com.gianluz.kite:kite-core:0.1.0-alpha10
   +--- com.gianluz.kite:kite-dsl:0.1.0-alpha10
   +--- com.gianluz.kite:kite-runtime:0.1.0-alpha10
   ```
...
2. **Check Version**:
   Ensure you're using a published version (e.g., `0.1.0-alpha10`, not `0.1.0-SNAPSHOT`)
