...
class ProcessExecutorTest {
    ...
    @Test
    fun `execute simple command successfully`() =
        runTest {
    ...
    @Test
    fun `execute command with multiple arguments`() =
        runTest {
    ...
    @Test
    fun `execute command in working directory`(
    ...
    @Test
    fun `execute command with environment variables`() =
        runTest {
            val result =
                if (System.getProperty("os.name").lowercase().contains("windows")) {
    ...
    @Test
    fun `execute command with timeout success`() =
        runTest {
    ...
    @Test
    fun `execute failing command throws exception`() =
        runTest {
            try {
    ...
    @Test
    fun `executeOrNull returns null on failure`() =
        runTest {
    ...
    @Test
    fun `executeOrNull returns result on success`() =
        runTest {
    ...
    @Test
    fun `execute nonexistent command throws exception`() =
        runTest {
            try {
    ...
    @Test
    fun `result includes command string`() =
        runTest {
    ...
    @Test
    fun `ProcessResult Success has output alias`() =
        runTest {
    ...
    @Test
    fun `execute command that produces large output`() =
        runTest {
    ...
    @Test
    fun `concurrent execution works correctly`() =
        runTest {
