...
class SequentialSchedulerTest {
    ...
    @Test
    fun `execute empty list returns empty result`() = runTest {
    ...
    @Test
    fun `execute single segment successfully`() = runTest {
        var executed = false
        val segment = Segment(
            name = "build",
    ...
    @Test
    fun `execute segments in topological order`() = runTest {
    ...
    @Test
    fun `handle segment failure`() = runTest {
        val build = Segment(
            name = "build",
    ...
    @Test
    fun `skip dependent segments on failure`() = runTest {
        val executionOrder = mutableListOf<String>()
    ...
    @Test
    fun `skip segment based on condition`() = runTest {
        var executed = false
    ...
    @Test
    fun `execute segment when condition is met`() = runTest {
        var executed = false
    ...
    @Test
    fun `result includes exception details`() = runTest {
    ...
    @Test
    fun `handle graph validation errors`() = runTest {
        val segment = Segment(
            name = "test",
    ...
    @Test
    fun `handle cyclic dependencies`() = runTest {
        val a = Segment(
            name = "a",
            dependsOn = listOf("b"),
            execute = { }
    ...
    @Test
    fun `SchedulerResult calculates totals correctly`() = runTest {
    ...
    @Test
    fun `SchedulerResult isSuccess true when all succeed`() = runTest {
        val segments = listOf(
    ...
    @Test
    fun `failedSegments returns only failed segments`() = runTest {
        val build = Segment(name = "build", execute = { })
        val test = Segment(
            name = "test",
            execute = { throw RuntimeException() }
    ...
    @Test
    fun `successfulSegments returns only successful segments`() = runTest {
        val build = Segment(name = "build", execute = { })
