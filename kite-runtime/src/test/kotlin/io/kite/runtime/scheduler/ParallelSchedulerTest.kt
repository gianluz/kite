...
class ParallelSchedulerTest {
    ...
    @Test
    fun `execute independent segments in parallel`() = runTest {
    ...
    @Test
    fun `execute segments by levels respecting dependencies`() = runTest {
    ...
    @Test
    fun `respect maxConcurrency limit`() = runTest {
    ...
    @Test
    fun `handle segment failure without blocking others`() = runTest {
        val executionOrder = mutableListOf<String>()
    ...
    @Test
    fun `execute complex dependency graph`() = runTest {
        val executionOrder = mutableListOf<String>()
