...
[![Version](https://img.shields.io/badge/version-0.1.0--alpha14-blue.svg)](https://github.com/gianluz/kite/releases)
...
dependencies {
    implementation("com.gianluz.kite:kite-core:0.1.0-alpha14")
    implementation("com.gianluz.kite:kite-dsl:0.1.0-alpha14")
    implementation("com.gianluz.kite:kite-runtime:0.1.0-alpha14")
}
```
...
|----------|-------------|-------------|--------|
| `kite-core` | `com.gianluz.kite:kite-core:0.1.0-alpha14` | Core domain models and interfaces | [🔗](https://central.sonatype.com/artifact/com.gianluz.kite/kite-core) |
| `kite-dsl` | `com.gianluz.kite:kite-dsl:0.1.0-alpha14` | DSL and Kotlin scripting engine | [🔗](https://central.sonatype.com/artifact/com.gianluz.kite/kite-dsl) |
| `kite-runtime` | `com.gianluz.kite:kite-runtime:0.1.0-alpha14` | Execution runtime and schedulers | [🔗](https://central.sonatype.com/artifact/com.gianluz.kite/kite-runtime) |
| `git` plugin | `com.gianluz.kite:git:0.1.0-alpha14` | Type-safe Git operations | [🔗](https://central.sonatype.com/artifact/com.gianluz.kite/git) |
| `gradle` plugin | `com.gianluz.kite:gradle:0.1.0-alpha14` | Flexible Gradle task execution | [🔗](https://central.sonatype.com/artifact/com.gianluz.kite/gradle) |

Plugins are used via `@file:DependsOn` in your `.kite.kts` scripts:

```kotlin
@file:DependsOn("com.gianluz.kite:git:0.1.0-alpha14")
@file:DependsOn("com.gianluz.kite:gradle:0.1.0-alpha14")
```
